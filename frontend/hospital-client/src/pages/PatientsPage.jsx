...
function PatientsPage() {
  ...
  async function handleStatusChange(patientId, status) {
    try {
          ...
          <table className="patients-table">
            <thead>
              <tr>
                ...
                <th>Status</th>
                {(perms.canUpdatePatient || perms.canDeletePatient) && (
                  <th>Actions</th>
                )}
              </tr>
            </thead>
                ...
                <tr key={patient._id}>
                  ...
                  <td>
                    <select
                      ...
                      onChange={(event) =>
                        handleStatusChange(patient._id, event.target.value)
                      }
                      disabled={!perms.canUpdatePatientStatus}
                    >
